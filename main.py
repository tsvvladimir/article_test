...
if __name__ == '__main__':
    ...
    if __name__ == '__main__':
        ...
        procs.append(Process(target=baseline_solution.baseline_solution, args=("fold2", prepare_data.fold2_train_data, prepare_data.fold2_train_target, prepare_data.fold2_test_data, prepare_data.fold2_test_target)))
